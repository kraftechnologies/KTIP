        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com/kraftechnologies" className="text-gray-400 hover:text-[#7B2FF2] transition-colors">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://x.com/kraftechnologies" className="text-gray-400 hover:text-[#7B2FF2] transition-colors">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/company/kraftechnologies/?viewAsMember=true" className="text-gray-400 hover:text-[#7B2FF2] transition-colors">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://instagram.com/kraftechnologies" className="text-gray-400 hover:text-[#7B2FF2] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="text-gray-600 hover:text-[#7B2FF2] transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
            ...
            <ul className="space-y-4">
              <li className="flex">
                ...
                <span className="text-gray-600">
                  400-A, 4th Floor, 12 Ajit Singh House, Yusuf Sarai Commercial Complex, New Delhi 110016
                </span>
              </li>
              <li className="flex">
              ...
              <li className="flex">
                ...
                <a href="mailto:info@kraftechnologies.com" className="text-gray-600">
          ...
          <div>
            ...
            <form className="flex flex-col space-y-3">
              <input type="email" placeholder="Your Email Address" className="bg-white border border-black text-gray-900 p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7B2FF2]" />
              <button type="submit" className="bg-gradient-to-r from-[#7B2FF2] to-[#22D1EE] text-white px-5 py-3 rounded-md font-medium hover:from-[#5F1EDC] hover:to-[#1CA7EC] transition-all">
                Subscribe
              </button>
            </form>
          </div>
