...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      quote: "KTIP was a turning point in my career. The hands-on experience with real projects and guidance from industry experts helped me secure a job at a leading tech company.",
      name: "Priya Sharma",
    ...
    {
      quote: "The mentorship I received during KTIP was invaluable. I learned not just technical skills but also how to approach problems and work in a team environment.",
      name: "Rahul Verma",
    ...
    {
      quote: "KTIP gave me the confidence to pursue my passion in technology. The supportive environment and challenging projects pushed me to grow both personally and professionally.",
      name: "Ananya Patel",
    ...
    <section id="testimonials" className="py-20 bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-3 text-gray-900">What Our Interns Say</h2>
          <div className="w-20 h-1 bg-[#18cb96] mx-auto mb-6"></div>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Hear from past participants about their experience with the Kraf Technologies Internship Program.
          </p>
        </div>
          ...
          <div className="relative overflow-hidden">
            ...
            >
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="bg-white rounded-lg shadow-md p-8 md:p-10 flex flex-col md:flex-row items-center">
                    ...
                    <div>
                      <Quote className="w-10 h-10 text-[#18cb96] opacity-30 mb-4" />
